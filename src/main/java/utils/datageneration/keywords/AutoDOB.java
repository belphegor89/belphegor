...
public class AutoDOB implements AutoKeyword {
    ...
    public String generateData() {
        LocalDate DOB = DataGenerator.getInstance().getDateBetween(18L, 65L);
    ...
    public String generateData(String modifier) {
        ...
        if (modifier.equals("NONE")) {
            DOB = DataGenerator.getInstance().getDateBetween(18L, 65L);
            ...
            if (modArray.length > 1) {
                if (modArray[1].contains("-")) {
                    ...
                    DOB = DataGenerator.getInstance().getDateBetween(early, later);
                } else {
                    long early = Long.parseLong(modArray[1]);
                    DOB = DataGenerator.getInstance().getDateBetween(early, early + 1L);
                }
            }
